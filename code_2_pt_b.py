...
print('Percentage rejected residuals bootstrap for 2d: ' + str(percentage_reject_resid_dep * 100) + '%')
print('Percentage rejected wild 2point bootstrap for 2d: ' + str(percentage_reject_wild_two_dep * 100) + '%')
